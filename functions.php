...
function get_sorted_categories( $order_by = 'date', $args = array() ){
    global $wpdb;
...
//https://stackoverflow.com/questions/53862332/meta-ogimage-not-working-for-my-wordpress-website-using-ssl
