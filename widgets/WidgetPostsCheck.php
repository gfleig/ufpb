 ...
 */
class WidgetNoticiasSimplesCheck extends WP_Widget {

    function __construct(){
        parent::__construct(
            'Widget_Noticias_Simples_Check',
            'Widget de Notícias Simples [NOVO]',
            array(
                'description' => 'Exibe as 4 últimas notícias em formato compacto, com seleção de categorias a serem exibidas'
            )
        );
    }
...
function WidgetNoticiasSimplesCheckInit() {
    register_widget( 'WidgetNoticiasSimplesCheck' );
}

add_action( 'widgets_init', 'WidgetNoticiasSimplesCheckInit' );
