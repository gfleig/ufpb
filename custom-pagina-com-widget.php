<?php 
/*
 * Template Name: Página com Widget
 * description: >-
  Template de página com espaço para widget
 */
get_header(); ?>
    ...
    <div class="corpo-grid">
        ...
        <div class="content-grid">             
            ...
            <div class="the-content-container">
                ...
                <?php //the_widget('WidgetNumerosMulheres'); ?>
                <?php $widget_values = dynamic_sidebar('widgets-pagina-custom'); ?>
